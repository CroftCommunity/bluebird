 ...
 * guardian-curated record that will live in the guardian's PDS (D2, Phase 2).
...
/**
 * DEV PLACEHOLDER — not a curated child's list. Three real, stable Bluesky
 * accounts so `npm run e2e:live` renders a genuine three-account garden. The
 * real list arrives from the guardian config in Phase 2.
 */
